...
public class RegisterDataProvider {
    ...
    public static Object[][] getInvalidRegisterData() {
        return new Object[][] {
                ...
                { new RegisterData("A", "testweb1@gmail.com", "Password123!", "name", "Tên quá ngắn (1 ký tự)") },
                { new RegisterData("Nguyễn Văn A", "testweb123@gmail.com", "12345", "password",
                ...
                { new RegisterData("Nguyễn Văn A", "testweb123gmail.com", "Password123!", "email",
                        "Email thiếu còng (@)") },
                { new RegisterData("Nguyễn Văn A", "testweb123@", "Password123!", "email", "Email thiếu domain") },
                { new RegisterData("Nguyễn Văn A", "testweb123@.com", "Password123!", "email",
                        "Email sai định dạng domain") },
                { new RegisterData("Nguyễn Văn A", "test web@gmail.com", "Password123!", "email",
                        "Email chứa dấu cách") },
                { new RegisterData("", "testweb1@gmail.com", "Password123!", "name", "Trống trường Họ và Tên") },
                { new RegisterData("Nguyễn Văn A", "", "Password123!", "email", "Trống trường Email") },
                { new RegisterData("Nguyễn Văn A", "testweb2@gmail.com", "", "password", "Trống trường Mật khẩu") },
