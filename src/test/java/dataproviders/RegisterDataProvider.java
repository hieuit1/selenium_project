    ...
    public static Object[][] getInvalidRegisterData() {
        return new Object[][] {
                ...
                { new RegisterData("Nguyễn Văn A", "testweb123gmail.com", "Password123!", "email",
                        "Email thiếu còng (@)") },
                { new RegisterData("Nguyễn Văn A", "test123@", "Password123!", "email", "Email thiếu domain") },
                ...
                { new RegisterData("Nguyễn Văn A", "test web@gmail.com", "Password123!", "email",
                        "Email chứa dấu cách") },
                { new RegisterData("", "test123@gmail.com", "Password123!", "name", "Trống trường Họ và Tên") },
                { new RegisterData("Nguyễn Văn A", "", "Password123!", "email", "Trống trường Email") },
                { new RegisterData("Nguyễn Văn A", "test123@gmail.com", "", "password", "Trống trường Mật khẩu") },
